...
- **Server** → Server → backend application (e.g. Flask/FastAPI)
...
---
## 🧱 9. Framework Layer (Implementation)

APIs are implemented using frameworks like:
...
- Connect backend logic (e.g. ML models)
...
> - **HTTP** → protocol (rules of communication)
> - **Frameworks (Flask / FastAPI)** → tools that implement APIs
